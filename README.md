...
Rather than aiming for maximum features, the emphasis is on clarity, correctness, and well-explained design decisions.
...
When the database is unavailable, the API responds with a controlled 503 error instead of crashing.
